...
**Note:** RSVP submissions are handled by the Next.js API route and appended to Google Sheets.
...
- **RSVP Data:** Appended to Google Sheets through `src/app/api/rsvp/route.ts`

**No database layer** — The system uses a Next.js API route with Google Sheets for RSVP collection.
