...
export function QuickFactsBand() {
  ...
  const quickFacts = [
    { icon: "📅", label: EVENT_DATA.copy.quickFacts.dateLabel, value: formatDateTime(WEDDING_DATE_ISO) },
    { icon: "📍", label: EVENT_DATA.copy.quickFacts.venueLabel, value: VENUE_GROOM.venueName },
    { icon: "👔", label: EVENT_DATA.copy.quickFacts.dressCodeLabel, value: EVENT_DATA.details.dressCode },
    { icon: "⏰", label: EVENT_DATA.copy.quickFacts.rsvpDeadlineLabel, value: formatDateTime(RSVP_DEADLINE_ISO) },
  ];
